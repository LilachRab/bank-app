...
>(({ className, children, ...props }, ref) => (
    <DialogPortal>
        ...
        >
            {children}
            <DialogPrimitive.Close className="absolute right-4 top-4 rounded-full p-1.5 bg-gray-100 hover:bg-gray-200 text-gray-700 dark:bg-gray-700 dark:text-gray-200 dark:hover:bg-gray-600 transition-colors outline-none focus:outline-none focus:ring-0 focus:ring-offset-0 disabled:pointer-events-none">
                <X className="h-4 w-4" />
